...
%>
<h3 class = "text-center">Hello    <%out.println(uname); %> </h3> Payment history for your number : <%out.println(pno1); %>==><%;
  ResultSet rs=st.executeQuery("select * from payment_history where pno = '"+pno1+"' ");
